...
public class SegmentedGroupView extends RadioGroup {
  ...
  public SegmentedGroupView(Context context, AttributeSet attrs) {
    ...
    View v = inflater.inflate(R.layout.segmented_control, this);
    mButton21 = (RadioButton) v.findViewById(R.id.button21);
    mButton22 = (RadioButton) v.findViewById(R.id.button22);
  ...
  public android.support.v4.app.Fragment newIndivFragment(){
    return new IndivFragment();
  }

  public android.support.v4.app.Fragment newTeamFragment(){
